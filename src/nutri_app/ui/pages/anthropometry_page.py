...
class AnthropometryPage(Page):
    ...
    def _save_anthropometry(self) -> None:
        ...
        if anthropometry.id is None:
            ...
            self._audit("atualizou_antropometria", anthropometry_id, "Avaliacao antropometrica atualizada.")
    ...
    def _delete_anthropometry(self) -> None:
        ...
        self._audit("excluiu_antropometria", anthropometry_id, "Avaliacao removida por exclusao logica.")
        self._clear_form()
        self._reload_table()
    ...
    def _reload_table(self) -> None:
        ...
        for row, record in enumerate(records):
            ...
            self.table.setItem(row, 7, QTableWidgetItem(self._format_optional(record.waist_hip_ratio)))
            self.table.setItem(row, 8, QTableWidgetItem(self._format_optional(record.waist_height_ratio)))
